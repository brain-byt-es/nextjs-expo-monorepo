...
Die LogistikApp REST-API ermöglicht die programmatische Integration in eigene Systeme, ERP-Software oder Automatisierungsplattformen.

## Basis-URL

```
https://app.logistikapp.ch/api/v1
```
...
```
GET https://app.logistikapp.ch/api/docs
```
