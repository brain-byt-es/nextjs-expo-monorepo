...
Wenn Sie ein **Geheimnis** gesetzt haben, enthält jeder Request den Header `X-Zentory-Signature`. Dieser ist ein HMAC-SHA256-Hash des Request-Body mit Ihrem Geheimnis:
