...
LogistikApp verwendet ein rollenbasiertes Berechtigungskonzept (Role-Based Access Control). Jeder Benutzer erhält eine Rolle, die genau festlegt, welche Aktionen er ausführen darf.
