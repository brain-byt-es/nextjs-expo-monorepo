...
Zentory wird von der **BrainBytes GmbH** (Schweiz) betrieben. Als Schweizer Unternehmen unterliegen wir dem revidierten Bundesgesetz über den Datenschutz (nDSG) sowie, sofern Sie Daten von Personen aus dem EU/EWR-Raum verarbeiten, der DSGVO.
