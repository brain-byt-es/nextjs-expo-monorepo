...
LogistikApp wird auf einer redundanten, hochverfügbaren Infrastruktur betrieben.

## Rechenzentren

Unsere primäre Infrastruktur befindet sich in **deutschen Rechenzentren von Hetzner** (Nürnberg und Falkenstein), die nach ISO 27001 zertifiziert sind. Für die Schweizer Kundschaft sind alle Daten-at-rest ausschliesslich in diesen EU-Rechenzentren gespeichert.
...
Wiederherstellung auf Anfrage: Kontaktieren Sie support@logistikapp.ch. RTO (Recovery Time Objective): 4 Stunden. RPO (Recovery Point Objective): 1 Stunde.

## Verfügbarkeit

- **SLA**: 99.9% Uptime (ca. 8.7 Stunden Ausfallzeit pro Jahr)
- **Enterprise SLA**: 99.95% Uptime
- **Status-Seite**: [status.logistikapp.ch](https://status.logistikapp.ch) — Echtzeit-Status und Incident-History
...
- **2FA**: Für alle Mitarbeitenden von BrainBytes GmbH mit Produktionszugang
...
Nur autorisierte BrainBytes-Mitarbeitende haben Zugriff auf Produktionssysteme — ausschliesslich via VPN + 2FA. Kein direkter Datenbankzugriff durch Support-Mitarbeitende ohne ausdrückliche schriftliche Genehmigung des Kunden.

## Responsible Disclosure

Falls Sie eine Sicherheitslücke entdecken, melden Sie diese bitte vertraulich an: **security@logistikapp.ch**. Wir antworten innerhalb von 48 Stunden und beheben kritische Schwachstellen innerhalb von 72 Stunden.
