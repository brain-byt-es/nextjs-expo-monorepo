...
const placeholderData: MaterialGroup[] = [
  { id: "1", name: "Befestigungsmaterial", color: "#3b82f6" },
  { id: "2", name: "Elektromaterial", color: "#ef4444" },
  { id: "3", name: "Sanitärmaterial", color: "#22c55e" },
  { id: "4", name: "Verbrauchsmaterial", color: "#f59e0b" },
  { id: "5", name: "Schmierstoffe", color: "#8b5cf6" },
  { id: "6", name: "Reinigungsmaterial", color: "#06b6d4" },
]
...
export default function MaterialGroupsPage() {
  ...
  const [items, setItems] = useState<MaterialGroup[]>([])
  ...
  return (
    <div className="flex flex-col gap-6 py-4 md:py-6">
      <div className="flex items-center justify-between px-4 lg:px-6">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">{t("materialGroups")}</h1>
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>{t("addMaterialGroup")}</DialogTitle>
            </DialogHeader>
